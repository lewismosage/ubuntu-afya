...
const boardOfDirectors = [
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['global-leadership', 'staff', 'founders', 'board-of-directors'];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-16">
            ...
            <div className="flex items-center">
              <p className="text-xl text-gray-600 leading-relaxed">
                At Ubuntu Afya, our people are the heartbeat of our mission to transform global health. From dedicated staff, to our global leadership teams, every individual plays a vital role in driving sustainable healthcare solutions. Together, we empower communities, provide life-saving care, and create lasting change for underserved populations around the world.
              </p>
            </div>
          </div>
          ...
          <div className="w-full h-96 bg-gray-300 rounded-lg mb-16 flex items-center justify-center">
            <span className="text-gray-500 text-lg">Team Hero Image Placeholder</span>
          </div>
        </div>
      </section>
      ...
      <section id="global-leadership" className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="border-b border-gray-200 mb-12">
            <h2 className="text-4xl font-bold text-teal-800 mb-4">Global Leadership Staff</h2>
          </div>
      ...
      <section id="board-of-directors" className="py-16 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="border-b border-gray-200 mb-12">
            <h2 className="text-4xl font-bold text-teal-800 mb-4">Board of Directors</h2>
          </div>
      ...
      <section className="py-20 px-6 bg-teal-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 leading-relaxed">
            Interested in being part of transforming global health? We're always looking for passionate individuals to join our team.
          </p>
