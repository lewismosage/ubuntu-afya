      ...
      <section className="relative py-20 px-6 bg-gradient-to-br from-teal-900/80 to-blue-900/80 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl lg:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed">
            Through community-driven solutions and innovative approaches, we're creating lasting impact 
            in healthcare access, quality, and sustainability across underserved communities.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive approach creates ripple effects that extend beyond healthcare, 
              empowering communities and building sustainable systems for generations to come.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Three interconnected pillars driving sustainable change in community healthcare
            </p>
          </div>
                ...
                <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-row-dense' : ''}`}>
                  ...
                  <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                    <div className="flex items-center space-x-3">
                      <div className={`p-3 rounded-lg ${colorClasses[area.color as keyof typeof colorClasses]}`}>
                        <IconComponent className={`w-6 h-6 ${textColors[area.color as keyof typeof textColors]}`} />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900">{area.title}</h3>
                        <p className="text-lg font-semibold text-gray-600">{area.subtitle}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-4">
                      {area.stats.map((stat, statIndex) => (
                        <div key={statIndex} className="text-center">
                          <div className={`text-2xl font-bold ${textColors[area.color as keyof typeof textColors]}`}>
                            {stat.value}
                          </div>
                    ...
                    <button className={`bg-${area.color}-500 hover:bg-${area.color}-600 text-white font-bold px-6 py-3 rounded-full transition-colors flex items-center`}>
                  ...
                  <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                    <div className="aspect-video bg-gray-300 rounded-lg flex items-center justify-center">
                      <span className="text-gray-500">Impact Image: {area.title}</span>
                    </div>
                  </div>
                </div>
              );
      ...
      <section className="py-20 px-6 bg-teal-600 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "The Ubuntu-Afya kiosk saved my daughter's life. Now I'm part of the community health team.",
                author: "Sarah M., Community Health Worker",
                location: "Kisumu County"
              },
              {
                quote: "STONE-HMIS® helps us track patient care seamlessly. Our efficiency has improved dramatically.",
                author: "Dr. James K., Clinic Director",
                location: "Migori County"
              },
              {
                quote: "Evidence-based training transformed how we deliver maternal care in our community.",
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-teal-500 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 leading-relaxed">
            Your support helps us expand our reach, deepen our impact, and transform 
            healthcare for communities in need. Together, we can build a healthier future.
          </p>
